...
# Save the scaler
joblib.dump(scaler, 'D:\\K8\\scaler.pkl')
print("Scaler saved as 'D:\\K8\\scaler.pkl'")
...
model.save('D:\\K8\\lstm_anomaly_model.h5')
joblib.dump(threshold, 'D:\\K8\\anomaly_threshold.pkl')
print("Model saved as 'D:\\K8\\lstm_anomaly_model.h5'")
print("Threshold saved as 'D:\\K8\\anomaly_threshold.pkl'")